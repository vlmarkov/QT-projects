    ...
    ui_(new Ui::MainWindow)
{
    ...
    this->netMonitor_ = new NetMonitor(this->ui_);
    ...
    this->netMonitor_->hwInfoGet();
    this->netMonitor_->hwInfoShow();
    this->netMonitor_->hwUsageGather(true);
